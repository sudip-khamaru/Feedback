<?php
	...
	$con="select * from mca_part1_1st_sem";
	$var=mysql_query($con);
	
	echo '<title>MCA Part-I, 1st Sem. Students Feedback</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:28%;top:0%;color:#116e11;text-shadow: 0.5px 0.5px #000000">MCA Part - I, 1st Sem. Students Feedback</h1>';
