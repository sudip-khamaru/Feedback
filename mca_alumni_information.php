...
<?php
	...
	$con="select * from alumni_mca";
	$var=mysql_query($con);
	
	echo '<title>MCA Alumni Informations</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:36.5%;top:0%;color:#116e11;text-shadow: 0.5px 0.5px #000000">MCA Alumni Informations</h1>';
		echo '<table style="position:absolute;left:12.5%;top:14%;border:2px solid #565c56" bgcolor="#d7ee91" border="2px" cellspacing="0px" cellpadding="3px" width="auto">';
