...
<?php
	...
	$con="select new_course,student_name,parent_name,roll_no,contact_no,email_id from unique_id";
	$var=mysql_query($con);
	
	echo '<title>MCA & M.TECH Student Informations</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:29.5%;top:5%;color:#116e11;text-shadow: 0.5px 0.5px #000000">MCA & M.TECH Student Informations</h1>';
		echo '<table style="position:absolute;left:27.5%;top:24%;border:2px solid #565c56" bgcolor="#d7ee91" border="2px" cellspacing="0px" cellpadding="3px" width="auto">';
			...
			while($row=mysql_fetch_array($var))
			{
				...
				echo '<td align="center"><i>'.$row[5].'</i></td></tr>';
			}
