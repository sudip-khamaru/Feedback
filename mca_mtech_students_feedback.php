...
<?php
	...
	$con="select * from student_feedback";
	$var=mysql_query($con);
	
	echo '<title>MCA & M.TECH Students Feedback</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:29.5%;top:0%;color:#116e11;text-shadow: 0.5px 0.5px #000000">MCA & M.TECH Students Feedback</h1>';
		echo '<table style="position:absolute;left:15.5%;top:14%;border:2px solid #565c56" bgcolor="#d7ee91" border="2px" cellspacing="0px" cellpadding="3px" width="auto">';
			echo '<tr><td align="center"><b>'."Student Name".'</b></td>';
			echo '<td align="center"><b>'."Course".'</b></td>';
			...
			while($row=mysql_fetch_array($var))
			{
				...
				echo '<td align="center"><i>'.$row[10].'</i></td></tr>';
			}
