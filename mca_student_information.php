...
<?php
	...
	echo '<title>MCA Student Informations</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:35.5%;top:5%;color:#116e11;text-shadow: 0.5px 0.5px #000000">MCA Student Informations</h1>';
