...
<?php
	...
	$con="select * from mtech_part2_1st_sem";
	$var=mysql_query($con);
	
	echo '<title>M.TECH Part-II, 1st Sem. Students Feedback</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:27%;top:0%;color:#116e11;text-shadow: 0.5px 0.5px #000000">M.TECH Part - II, 1st Sem. Students Feedback</h1>';
		echo '<table style="position:absolute;left:21.5%;top:14%;border:2px solid #565c56" bgcolor="#d7ee91" border="2px" cellspacing="0px" cellpadding="3px" width="auto">';
