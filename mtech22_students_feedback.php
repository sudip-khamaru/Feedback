...
<?php
	...
	$con="select * from mtech_part2_2nd_sem";
	$var=mysql_query($con);
	
	echo '<title>M.TECH Part-II, 2nd Sem. Students Feedback</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:27%;top:0%;color:#116e11;text-shadow: 0.5px 0.5px #000000">M.TECH Part - II, 2nd Sem. Students Feedback</h1>';
