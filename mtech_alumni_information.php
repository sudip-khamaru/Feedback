...
<?php
	...
	$con="select * from alumni_mtech";
	$var=mysql_query($con);
	
	echo '<title>M.TECH Alumni Informations</title>';
	...
	if($var>0)
	{
		...
		echo '<CENTER>';
		echo '<h1 style="position:absolute;left:36.5%;top:0%;color:#116e11;text-shadow: 0.5px 0.5px #000000">M.TECH Alumni Informations</h1>';
		echo '<table style="position:absolute;left:16.5%;top:14%;border:2px solid #565c56" bgcolor="#d7ee91" border="2px" cellspacing="0px" cellpadding="3px" width="auto">';
			...
			while($row=mysql_fetch_array($var))
			{
				...
				echo '<td align="center"><i>'.$row[6].'</i></td></tr>';
			}
